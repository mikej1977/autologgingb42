...
function ISLoggingPopup:render()
    ...
    local tex1 = getTexture("media/ui/Sidebar/Autologging_On.png")
    self:drawTextureScaled(tex1, 0, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)

    local tex2 = getTexture("media/ui/Sidebar/GatherLogs.png")
    self:drawTextureScaled(tex2, TEXTURE_WIDTH, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)

    local tex3 = getTexture("media/ui/Sidebar/GatherPlanks.png")
    self:drawTextureScaled(tex3, TEXTURE_WIDTH * 2, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)

    local tex4 = getTexture("media/ui/Sidebar/GatherTwigs.png")
    self:drawTextureScaled(tex4, TEXTURE_WIDTH * 3, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)

    local tex5 = getTexture("media/ui/Sidebar/Autologging_Off.png")
    self:drawTextureScaled(tex5, TEXTURE_WIDTH * 4, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)

    local tex6 = getTexture("media/ui/Sidebar/Autologging_Off.png")
    self:drawTextureScaled(tex6, TEXTURE_WIDTH * 5, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)

    local tex7 = getTexture("media/ui/Sidebar/Autologging_Off.png")
    self:drawTextureScaled(tex7, TEXTURE_WIDTH * 6, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)

    local tex8 = getTexture("media/ui/Sidebar/Autologging_Off.png")
    self:drawTextureScaled(tex8, TEXTURE_WIDTH * 7, 0, TEXTURE_WIDTH, TEXTURE_WIDTH, 1)
end
...
function ISEquippedItem:prerender()
    ...
    local options = true
    if not isClient() or not isServer() then
        options = PZAPI.ModOptions:getOptions("JBLoggingModOptions")
