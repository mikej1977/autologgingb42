...
local queues = {} -- we'll queue by player num

local ActionSpeedKeeper = require("jb_SpeedKeeper")

--- adds a task to the player's queue
...
function JBLogging.ActionPlayer.start(playerObj)
    ...
    -- Initialize SpeedKeeper to keep time sped up across the whole queue
