...
JBLogging.GetSquareAndArea = function(worldObjs, playerObj, logicFunc, ...)
    local args = { ... }
    JB_ASSUtils.SelectSquareAndArea(worldObjs, playerObj, logicFunc, unpack(args))
end
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetSquareAndArea, JBLogging.gatherLogs },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetSquareAndArea, JBLogging.gatherPlanks },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetSquareAndArea, JBLogging.gatherFirewood },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetSquareAndArea, JBLogging.gatherStones },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetSquareAndArea, JBLogging.gatherTwigsAndBranches },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetArea, JBLogging.unifiedClear, "Tree" },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetArea, JBLogging.unifiedClear, "Stump" },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetArea, JBLogging.unifiedClear, "Bush" },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetArea, JBLogging.unifiedClear, "Grass" },
})
...
JBLogging.registerMenuOption({
    ...
    action = { JBLogging.GetArea, JBLogging.unifiedClear, "Boulder" },
})
